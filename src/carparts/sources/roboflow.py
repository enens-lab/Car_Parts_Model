...
class RoboflowSource(Source):
    def __init__(self, name: str, workspace: str, project: str, version: int, info: SourceInfo,
        ...
        self.taxonomy = taxonomy  # "engine_bay" -> normalise class names onto the canonical 26
    ...
    def load(self, raw_root: Path) -> dict[str, CocoDataset]:
        ...
        for split in ("train", "valid", "test"):
            ...
            if self.taxonomy == "engine_bay":
                ds = ds.remap_classes(engine_bay_class_map(ds.class_names, drop_unknown=True))
